...
import { formatBusinessDayRange, useBusinessDayStart } from "../lib/businessDay";
...
export default function Dashboard() {
  ...
  const stats = useMemo(() => {
    const now = new Date();
    const startOfDay = businessDayStart;
  ...
  }, [orders, tables, inventory, settings, businessDayStart]);
